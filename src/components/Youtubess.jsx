...
<div className="w-full flex items-center justify-between bg-[#2D2D2D] p-1">
          <div className="flex items-center gap-2  ">
            ...
            <div onClick={bool?handle:rizemin} className="w-5 h-5 bg-yellow-400 rounded-full"></div>
                        ...
                        <div onClick={()=>setYoutube(false)} className="  text-red-600 "><IoRemoveCircleSharp className='w-6 h-6' /></div>
          ...
          <span className="text-xs text-gray-400 pr-2">
            ...
            <div className='w-full h-full '>
                 <iframe className='w-full h-full' src="https://www.youtube.com/embed/63IGdvpsNK0" frameborder="0"></iframe>
            </div>
      </div>
    </div>
  );
